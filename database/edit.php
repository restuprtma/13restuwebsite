            ...
            <div class="col-md-12">
                <form action="edit_process.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control" value="<?php echo $barang["nama_barang"] ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInput">Ukuran</label>
                        <input type="text" name="ukuran" class="form-control" value="<?php echo $barang["ukuran"] ?>" required>
                    </div>
                    <div class="form-group">
